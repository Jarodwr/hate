--[[
	Sorting code implementation by s.fisher licensed under CC0
	source: http://lua-users.org/lists/lua-l/2013-05/msg00038.html
]]
--[[
	Subject: A stable sort
	From: "S. Fisher" <expandafter@...>
	Date: Thu, 2 May 2013 15:10:50 -0700 (PDT)
